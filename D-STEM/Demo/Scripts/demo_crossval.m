...
crossval_indices=1:2:n2;
obj_stem_crossval=stem_crossval({'pm2.5 ground'},{'point'},{crossval_indices});
...
exit_toll = 0.001;
max_iterations = 1;
obj_stem_EM_options = stem_EM_options(exit_toll,max_iterations,'single',[],1);
